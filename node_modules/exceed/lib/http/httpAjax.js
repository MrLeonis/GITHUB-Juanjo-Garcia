...
var _require = require('./utils'),
    getCallbackPrefix = _require.getCallbackPrefix,
    toQueryString = _require.toQueryString,
    buildParams = _require.buildParams;
...
xmlHttpRequest = 'XMLHttpRequest',
  ...
  if (o.crossOrigin === true) {
    var _xhr = context[xmlHttpRequest] ? new XMLHttpRequest() : null;
    if (_xhr && 'withCredentials' in _xhr) {
      return _xhr;
...
function handleReadyState(r, success, error) {
  return function () {
    ...
    if (r.request && r.request[readyState] == 4) {
      ...
      if (succeed(r)) success(r.request);else {
        error(r.request);
      }
    }
  };
...
function getRequest(fn, err) {
  ...
  data = o.processData !== false && o.data && typeof o.data !== 'string' ? toQueryString(o.data) : o.data || null,
      http = void 0,
      sendWait = false;
...
function init(o, fn) {
  ...
  if (o.success) {
    var _loop = function _loop() {
      var successHandler = o.success.shift();
      _this._successHandlers.push(function (resp, originResp) {
  ...
  if (o.error) {
    var _loop2 = function _loop2() {
      var errorHandler = o.error.shift();
      _this._errorHandlers.push(function (resp, msg, t) {
  ...
  if (o.complete) {
    var _loop3 = function _loop3() {
      var completeHandler = o.complete.shift();
      _this._completeHandlers.push(function () {
        completeHandler(_arguments, o);
      });
    };
  ...
  function complete(resp) {
    ...
    while (self._completeHandlers.length > 0) {
      var _completeHandler = self._completeHandlers.shift();
      _completeHandler(resp);
    }
  }
  ...
  function success(resp) {
    ...
    while (self._successHandlers.length > 0) {
      var _successHandler = self._successHandlers.shift();
      _successHandler(resp, originResp);
    }
    while (self._fulfillmentHandlers.length > 0) {
      var fulfillmentHandler = self._fulfillmentHandlers.shift();
  ...
  function error(resp, msg, t) {
    ...
    while (self._errorHandlers.length > 0) {
      var _errorHandler = self._errorHandlers.shift();
      _errorHandler(resp, msg, t);
    }
    complete(resp);
  }
